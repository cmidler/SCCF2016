    ...
    return (
      <View style={[styles.navBarContainer, customTintColor, ]}>
        ...
        <View style={[styles.navBar, this.props.style, ]}>
          ...
          {this.getButtonElement(this.props.centerButton1, { marginLeft: 14, })}
          {this.getButtonElement(this.props.centerButton2, { marginRight: 20, })}
          {this.getButtonElement(this.props.centerButton3, { marginRight: 12 })}
