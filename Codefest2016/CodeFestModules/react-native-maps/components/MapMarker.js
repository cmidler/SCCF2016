...
var MapMarker = React.createClass({
  ...
  //prevent universal marker refresh
  shouldComponentUpdate(nextProps, nextState) {
      if (this.props.coordinate.latitude == updateLat && this.props.coordinate.longitude == updateLon) {
        console.log('shouldComponentUpdate called on MapMarker - TRUE');
